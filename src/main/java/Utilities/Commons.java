...
public class Commons {
	...
	public static final String BASE_URL = "https://insidekampus.com/home";
	...
	public static final String FIREFOX_DRIVER_NAME = "geckodriver";

	public static final String SHEET_1 = "Sheet1";

	public static final String SHEET_2 = "Sheet2";
	
	public static final String SHEET_3 = "Sheet3";
